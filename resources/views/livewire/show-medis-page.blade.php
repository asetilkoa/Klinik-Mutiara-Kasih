<main>
    ...
    <section class="section teams py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <h1>Tim Medis Kami</h1>
                        <p class="mb-0">Tim Medis yang profesional, ramah dan ahli dalam bidangnya sehingga dapat memberikan pelayanan yang maksimal.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row position-relative">
                ...
                $x=1;
                @endphp
                @foreach ($medis as $mediss)
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    <x-medis-card :mediss="$mediss" :x="$x" />
                </div>
                @endforeach
                @endif
            </div>
